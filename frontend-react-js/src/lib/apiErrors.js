...
const MESSAGES = {
  ...
  weekday_taken: 'That day already has a workout. Pick another day, or replace it.',
  weekday_invalid: 'Pick a day of the week.',
  planned_workout_not_found: 'That planned workout no longer exists.',
  plan_not_found: 'There is no plan yet.',
  plan_exists: 'You already have a plan.',
  name_invalid: 'Give the workout a name of up to 60 characters.',
  notes_invalid: 'Notes must be under 500 characters.',
  exercises_invalid: 'Something is wrong with the exercise list.',
  too_many_exercises: 'A workout can have up to 30 exercises.',
  exercise_id_invalid: 'Pick an exercise for every row.',
  target_sets_invalid: 'Sets must be a whole number from 1 to 20.',
  target_reps_invalid: 'Reps must be whole numbers, and the top of a range must be higher than the bottom.',
  target_weight_invalid: 'Weight must be a number from 0 to 2000.',
  target_weight_unit_invalid: 'Choose kg or lb.',
  target_weight_unit_required: 'Choose kg or lb for the target weight.',
  started_at_blank: 'Could not start the workout. Please try again.',
  started_at_invalid: 'Could not start the workout. Please try again.',
  range_invalid: 'That date range is not valid.',
